...
/// <summary>
/// High-level service for resolving shell identifiers by orchestrating multiple
/// <see cref="IShellResolverStrategy"/> instances. This is the main resolver service used by
/// the application to determine the current shell.
/// </summary>
public interface IShellResolver
{
    /// <summary>
    /// Resolves a shell identifier from the provided context by trying all registered
    /// strategies in order.
    /// </summary>
