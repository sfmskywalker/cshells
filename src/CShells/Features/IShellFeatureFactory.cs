...
public interface IShellFeatureFactory
{
    ...
    ///   </item>
    ///   <item>
    ///     <description>Supporting features with or without <see cref="ShellSettings"/> dependency</description>
    ///   </item>
    /// </list>
    /// </remarks>
    T CreateFeature<T>(Type featureType, ShellSettings? shellSettings = null) where T : class;
}
